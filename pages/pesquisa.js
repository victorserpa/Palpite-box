  ...
  return (
    <div className='pt-6'>
      ...
      {!sucess && <div className='w-1/5 mx-auto mb-6'>
        ...
        <input type='text' className='p-4 block shadow bg-blue-100 my-2 rounded' placeholder='Crítica ou sugestão' onChange={onChange} name='Crítica' />
      ...
      {sucess && <div className='w-full md:w-1/5 mx-auto mb-6'>
        ...
        {
          retorno.showCoupon && <div className='text-center border shadow-md p-4 mb-4'>
          Seu Cupom: <br />
        ...
        }
        {
          ...
          <br />
          <spa className='italic'>Tire um print ou foto desta tela e apresente ao garçon.</spa>
          </div>
        }
        </div>}
    </div>
